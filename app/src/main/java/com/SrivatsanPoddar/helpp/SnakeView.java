...
public class SnakeView extends TileView {
    ...
    private void initSnakeView() {
        ...
        resetTiles(4);
        loadTile(RED_STAR, r.getDrawable(R.drawable.snake_body));
        loadTile(YELLOW_STAR, r.getDrawable(R.drawable.snake_head));
        loadTile(GREEN_STAR, r.getDrawable(R.drawable.snake_border));
...
//    }
    ...
    public void setMode(int newMode) {
        ...
        if (newMode == LOSE) {
            ...
            final String preferenceKey = "com.SrivatsanPoddar.helpp.snake_high_score";
            long previousHighScore = prefs.getLong(preferenceKey, 0);
            if (mScore > previousHighScore) {
